...
public class JFXPopup extends AnchorPane
{
	...
	/**
	 * creates emptyActionHandler popup
	 */
	public JFXPopup()
	{
		this(null, null);
	...
	public void show(PopupVPosition vAlign, PopupHPosition hAlign, double initOffsetX, double initOffsetY)
	{
		...
		animation.setRate(1);
		animation.setOnFinished(onPopup);
		animation.play();
	}

	private EventHandler<ActionEvent> emptyActionHandler()
	{
		return e ->
		{};
	}

	private EventHandler<ActionEvent> onPopup = emptyActionHandler(), onClose = emptyActionHandler();

	public EventHandler<ActionEvent> getOnPopup()
	{
		return onPopup;
	}

	public void setOnPopup(EventHandler<ActionEvent> onPopup)
	{
		if (onPopup == null) onPopup = emptyActionHandler();
	...
	{
		if (onClose == null) onClose = emptyActionHandler();
