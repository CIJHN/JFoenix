...
//            });
            ...
            JFXTableView<User> treeView = new JFXTableView<>(users);
...
//            main.getChildren().add(unGroupButton);
            ...
            filterField.textProperty().addListener((o, oldVal, newVal) -> {
                treeView.getFilterMap().put("common", user -> user.age.get().contains(newVal) || user.department.get().contains(newVal) || user.userName.get().contains(newVal));
            });
//
